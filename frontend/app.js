/**
 * NewRH Corp — Portal de Carreiras
 */
...
const EMAILS_GESTOR = []; // Configure com os e-mails dos gestores da sua empresa
...
const Manager = {
  ...
  async inviteUser() {
    ...
    if (!email.endsWith('@suaempresa.com.br')) {
      showAlert('register-alert', '❌ Apenas e-mails @suaempresa.com.br são permitidos.');
      return;
    }
    try {
      ...
      document.getElementById('modal-candidate-body').innerHTML = `
        ...
        <div id="print-profile-${app.id}" class="print-profile">
          <div class="print-header">
            <div class="print-header__title">Ficha do Candidato — NewRH Corp</div>
  ...
  async exportCsv() {
    try {
      ...
      a.download = `candidaturas_${hoje}.xlsx`;
      a.click();
